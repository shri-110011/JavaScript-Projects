...
// heap.insert({ key: "A", dValue: 10 });
// heap.insert({ key: "B", dValue: 8 });
// heap.insert({ key: "C", dValue: 4 });
// heap.insert({ key: "D", dValue: 9 });
// heap.insert({ key: "E", dValue: 1 });
// heap.insert({ key: "F", dValue: 6 });
// heap.insert({ key: "G", dValue: 23 });
// heap.insert({ key: "H", dValue: 11 });
// heap.insert({ key: "I", dValue: -1 });
// heap.insert({ key: "J", dValue: 5 });
// heap.insert({key: 'A', dValue:-9});
...
let heap2 = new Heap("min", new Map(items));
heap2.heapify();
...
// console.log(heap2.delete());
// console.log(heap2.items);
// console.log(heap2.keyIndexMap);
// heap2.insert({key:"C", dValue:12});

heap2.decrementKey("C", 7);
console.log(heap2.items);
console.log(heap2.keyIndexMap);
