...
app.use(express.static("view"));//This middleware ensures that any static files requested are checked in this folder
...
app.get("/", function(req, res){
	res.render(__dirname+"/views/index", {title:"My first project using Pug", message: "Hello Earth!"});
});
